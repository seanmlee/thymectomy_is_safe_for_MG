...
newdata2 <- data.frame(
  ...
  year = seq(9.5, 14, length.out = 100),
  period = rep("post", 100),
  mg_total = rep(30.5, 100)
...
rate_summary %>%
  ...
  scale_x_continuous(
    ...
    labels = c(2008, 2009, 2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021)
  ...
  ylab("Rate of Thymectomy for MG") +
